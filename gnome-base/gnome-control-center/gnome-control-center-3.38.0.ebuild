...
DEPEND="
	...
	>=gnome-base/gsettings-desktop-schemas-3.37.1
	dev-libs/libxml2:2
...
PATCHES=(
	...
	"${FILESDIR}"/0001-build-Restore-options-for-bluetooth-NetworkManager-a.patch
	"${FILESDIR}"/0002-build-Make-kerberos-optional.patch
	"${FILESDIR}"/0003-build-Make-grilo-and-gnome-online-accounts-optional.patch
	"${FILESDIR}"/0004-build-Make-printers-panel-cups-optional.patch
	"${FILESDIR}"/0005-Fix-absolute-paths-to-be-dependent-on-build-configur.patch
	"${FILESDIR}"/0006-support-tracker-3.0.patch
)
