...
PATCHES=(
	...
	"${FILESDIR}"/0002-build-Make-colord-and-wacom-optional-and-controllabl.patch
	"${FILESDIR}"/0003-build-Allow-NM-optional-on-Linux.patch
	"${FILESDIR}"/0004-Allow-udev-optional-on-Linux.patch
