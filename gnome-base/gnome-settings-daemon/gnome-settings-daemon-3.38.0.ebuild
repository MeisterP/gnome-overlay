...
PATCHES=(
	...
	# Make wacom optional
	"${FILESDIR}"/0001-build-Make-wacom-optional-and-controllable-via-meson.patch
	"${FILESDIR}"/0002-build-Allow-NM-optional-on-Linux.patch
	"${FILESDIR}"/0003-Allow-udev-optional-on-Linux.patch
