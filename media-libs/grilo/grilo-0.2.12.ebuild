...
# $Header: /var/cvsroot/gentoo-x86/media-libs/grilo/grilo-0.2.12.ebuild,v 1.1 2015/06/09 16:30:22 eva Exp $
...
inherit gnome2 python-any-r1 vala eutils autotools
...
IUSE="gtk examples +introspection +network +vk playlist test vala"
...
src_prepare() {
	use vk && epatch "${FILESDIR}"/grilo.patch
