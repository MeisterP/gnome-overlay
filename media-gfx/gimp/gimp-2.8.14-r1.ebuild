...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/gimp/gimp-2.8.14.ebuild,v 1.2 2015/01/29 17:21:06 mgorny Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-2.8.14-gegl-0.3.patch # bug 449370 compile with clang
