...
inherit autotools check-reqs toolchain-funcs pax-utils mozcoreconf-v6
...
SRC_URI="https://ftp.acc.umu.se/pub/GNOME/teams/releng/tarballs-needing-help/mozjs/${MY_P}.tar.bz2"
