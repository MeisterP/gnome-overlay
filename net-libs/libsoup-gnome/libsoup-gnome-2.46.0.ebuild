...
# $Header: /var/cvsroot/gentoo-x86/net-libs/libsoup-gnome/libsoup-gnome-2.42.2.ebuild,v 1.1 2013/08/29 22:08:34 eva Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-2.44.0-system-lib.patch
	eautoreconf
	gnome2_src_prepare
}
